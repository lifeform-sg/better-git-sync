...
An improved GitHub Action for syncing between two independent repositories using **force push**.
Based off Wei's Git Sync.
...
```yml
# .github/workflows/better-git-sync.yml
...
jobs:
  better-git-sync:
    ...
    steps:
      - name: better-git-sync
        uses: lifeform-sg/better-git-sync@0.1.0
        with:
